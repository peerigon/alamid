var fs = require('fs'),
    ...
    services = require('../server/services.js').services,
    validators = require('../server/validators.js').validators,
    paths = require('../shared/helpers/paths.js'),
    settings = require('./config'),
    modifyPathsInHTML = require('../shared/helpers/modifyPathsInHTML.js');
