...
var config = require("../../../core/config"),
    ...
    resolvePathToServiceFilePath = require("../../../shared/helpers/resolvePaths.js").resolvePathToServiceFilePath;
...
function runService(req, res, next) {
        ...
        if(service[method] === undefined){
            ...
            switch(req.getMethod()) {
                ...
                case 'read':
                    ...
                    if(req.getIds()[req.getPath()] === undefined) {
    ...
    //this could also be a standalone middleware
        path = resolvePathToServiceFilePath(req.getPath()),
