...
var config = require("../../../core/config"),
    ...
    emitPush = require("../../transport/websocket/emitPush.js"),
    ...
    function onServiceCallback(resObj) {
        ...
        if(resObj.status === "success") {
            if(method === "update" || method === "delete") {
                //check if activeRoom has set
                if(req.getSession().activeRoomID !== undefined){
                    emitPush("/", method, model.getUrl(), model.getId(), resObj.data);
                }
            }
        }
