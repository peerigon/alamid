...
var log = require("../../../shared/logger.js").get("server"),
    ...
    getModelPathFromRequestPath = require("../../../shared/helpers/resolvePaths.js").getModelPathFromRequestPath;
...
function loadModel(req, res, next) {
    ...
    var modelPath = getModelPathFromRequestPath(req.getPath(), req.getIds()),
        ids = req.getIds(),
        id = null,
