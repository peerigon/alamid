...
var ViewCollection = new Class({
     ...
     * @protected
     */
    //@TODO Could this be solved more efficient wiht _destroyViews() if only views are recreated which are really new?
    _createNewViews: function () {
        ...
        this._models.each(function createNewView(model, index) {
            newView = self._viewFactory();
            newView.bind(model);
