...
var Displayable = EventEmitter.extend("Displayable", {
    ...
    constructor: function (node) {
        ...
        this._super();
        this._children = [];
        // regular expression to determine if an element has a specific class
        this._hasClass = new RegExp('(^|\\s)' + this.cssClassHide + '($|\\s)');
     ...
     */
    isVisible: function () {
        return this._hasClass.test(this._root.className) === false;
    },
    ...
    show: function () {
        ...
        if (this.isVisible() === false) {
            toggleClass(this._root, this.cssClassHide, this._hasClass, false);
    ...
    hide: function () {
        ...
        if (this.isVisible()) {
            toggleClass(this._root, this.cssClassHide, this._hasClass, true);
 ...
 * @param {RegExp} regexp (for performance reasons)
 * @param {Boolean} on
 */
function toggleClass(el, newClass, regexp, on) {
   var className = el.className || "";

   if (on) {
       el.className += (className.length ? " " : "" ) + newClass + " ";
   } else {
