 ...
 * - default validation on both sides!
 */
//OLD CHEESE
function RemoteValidatorWrapper(validatorPath) {
    var uri = settings.baseURL + '/' + validatorPath;
...
function getValidators(path) {
    var validatorPath = 'validators/' + resolve(path),
        isServerAvailable = validators.server['node_modules/' + validatorPath + '.server.js'],
        isClientAvailable = validators.client['node_modules/' + validatorPath + '.client.js'],
        result = {};
