...
var App = new Class({
    ...
    start: function (pageJSOptions) {
        ...
        */
        ...
        if (pageJSOptions !== undefined) {
            _.extend(pageJSDefaultOptions, pageJSOptions);
        }

        pageJS.start(pageJSDefaultOptions);
    ...
    changePage: function (pageURL, params) {
        ...
        preventDefault = this.__emitBeforePageChange(pageURL, params);
        if (preventDefault) {
            return;
        }
        ...
        preventDefault = this.__emitLeaveEventOnPages(pagesToLeave);
        if (preventDefault) {
            return;
        }
