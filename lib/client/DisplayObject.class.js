...
var DisplayObject = new Class({
     ...
     * @protected
     */
    __isDisplayed: true, //@TODO Make protected

    /**
     * @type {Boolean}
     * @protected
     */
    __isAppended: false, //@TODO Make protected
    ...
    display: function (animator) {
        ...
        domAdapter(this._node).removeClass(ALAMID.HIDE_CLASS);
    ...
    hide: function () {
        ...
        domAdapter(this._node).addClass(ALAMID.HIDE_CLASS);
