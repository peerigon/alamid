...
var DisplayObject = new Class({
    ...
    _append: function (displayObject) {
        ...
        return this._addNode(displayObject);

    },

    /**
     * How to use: displayObjectInstance._prepend(new displayObjectInstance()).at("nodeName").
     *
     * @param {!DisplayObject} displayObject
     * @return {Object.<string, function(string): DisplayObject>}
     * @protected
    ...
    _prepend: function (displayObject) {
        ...
        if (is(displayObject).notInstanceOf(DisplayObject)) {
            throw new TypeError("(alamid) type error: ._prepend() takes only objects kind of DisplayObject.");
        }

        return this._addNode(displayObject, true);
    },
     ...
     * @private
     */
    _addNode: function (displayObject, prepend) {
        ...
        var self = this,
            ...
            at: function (nodeName) {
                ...
                displayObject.emit("before" + event);
