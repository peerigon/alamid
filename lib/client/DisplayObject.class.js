...
var DisplayObject = new Class({
    ...
    /**
     * @param {object.<string, object>} nodeEventsMap
     */
    attachEvents: function (nodeEventsMap) {
        ...
        _(nodeEventsMap).each(eventMapIterator);
    },
    ...
    _append: function (displayObject) {
        ...
        //@TODO notInstanceOf is throwing an TypeError
        /*
    ...
    dispose: function () {
         ...
         * @param {Node} node
         */
        function disposeNodeMapIterator(node) {
            domAdapter(node).off();
        }

        /**
         * @param {DisplayObject} displayObejct
         */
        function disposeDisplayObjectMapIterator(displayObejct) {
            displayObejct.dispose();
        }
        ...
        if (this.__hasDomEvents) {
            _(this.__nodeMap).each(disposeNodeMapIterator);
        }
        this.__hasDomEvents = false;

        _(this.__displayObjectMap).each(disposeDisplayObjectMapIterator);
