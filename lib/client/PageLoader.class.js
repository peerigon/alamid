...
var PageLoader = new Class("PageLoader", {
    ...
    init: function (pageURLs) {
        ...
        if (value(pageURLs).notInstanceOf(Array) || pageURLs.length === 0) {
    ...
    load: function (params, callback) {
        ...
        _(this.__bundles).each(function loadPage(bundle, index) {
            ...
            bundle(function onPageBundleLoaded(PageClassOrTemplate) {
                ...
                if (value(PageClassOrTemplate).instanceOf(String)) {
                    page = new Page(params, PageClassOrTemplate);
                } else if (value(PageClassOrTemplate).instanceOf(Function)) {
