...
if (typeof window !== "undefined" &&
    // Test if the browser-engine is Zombie.js.
    // This is a workaround because the historyAdapter.js doesn't run in Zombie.js
    // Remove this line if Zombie.js or the history adapter have been patched.
    // @see https://github.com/peerigon/alamid/issues/88
    navigator.userAgent.search(/Zombie\.js/) === -1) {
    ...
    (function( window, True, False, Null, undefined ) {
            ...
            normalizeUrl = (function( a ) {
                ...
                return function( href, test ) {
                    ...
                    if ( !href ) {
                        ...
                        href = /^(?:[a-z]+\:)?\/\//.test( href ) ?
                            _(href).indexOf( "/" ) === 0 ? _protocol + href :
                                href : _protocol + "//" + current._host + (
                            _(href).indexOf( "/" ) === 0 ? href :
                                _(href).indexOf( "?" ) === 0 ? _pathname + href :
                                    _(href).indexOf( "#" ) === 0 ? _pathname + current._search + href :
                    ...
                    if ( _href !== href ) {
                        ...
                        pathname = _(pathname).indexOf( "/" ) === 0 ? pathname : "/" + pathname;
        ...
        // The new Location object to add it to the object of History
            Location = {
                "assign": function( url ) {
                    windowLocation.assign( api || _(url).indexOf( "#" ) !== 0 ? url : "#" + normalizeUrl()._nohash + url );
                },
                "reload": windowLocation.reload,
                "replace": function( url ) {
                    windowLocation.replace( api || _(url).indexOf( "#" ) !== 0 ? url : "#" + normalizeUrl()._nohash + url );
                },
                "toString": function() {
                    return this.href;
                }
