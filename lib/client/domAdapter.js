 ...
 * NOTE: Parent element is not included in find():
 *
 ...
 * In difference to simple find the parent element will be also looked up for data-node-attribute as well.
 * @see {exports.find}
 *
...
exports.findNodes = function findNodes(dataNodeValue, parent) {
    ...
    if (dataNodeValue) {
        ...
        elements = exports.find("[data-node='" + dataNodeValue + "']", parent);

        if ($parent.attr("data-node") === dataNodeValue) {
            elements.push(parent);
        }

    } else {

        elements = exports.find("[data-node]", parent);

        if ($parent.attr("data-node")) {
            elements.push(parent);
        }
 ...
 * @return {Object}
 */
exports.parseQuery = function parseQuery(querystring) {
