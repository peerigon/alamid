...
module.exports = new Class({
    ...
    init: function init(id) {
        ...
        var url = this.Instance.constructor.url,
            schema,
            service;
    ...
    "$find" : function $find(obj, callback) {
        ...
        //call batch-service here (Class-reference, filter-data, callback)
        //or maybe just data instead of class
        //services.readCollection(this, obj, callback);
    },
