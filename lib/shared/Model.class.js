...
var Model = new Class({
    ...
    __callService : function(serviceFunction, remote, model, ids, data, callback) {
        ...
        if(config.isServer) {
            ...
            if(remote) {
                ...
                remote = new RemoteService(this.__url);
            }
        }
    ...
    fetch: function fetch(remote, callback) {
        ...
        this.__callService(service.read, remote, ids, onServiceResponse);
    },
    /**
    ...
    save: function save(remote, callback) {
        ...
        this.__callService(service[method], remote, ids, this.Instance, onServiceResponse);
    },
    /**
    ...
    delete: function (remote, callback) {
        ...
        this.__callService(service.delete, remote, ids, onServiceResponse);
    },
    /**
