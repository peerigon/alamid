...
var value = require("value"),
    ...
    forEachItem = require("./helpers/forEachItem.js"),
...
var Model = EventEmitter.extend("Model", {
    ...
    get: function (key) {
        ...
        return forEachItem(keysToLoad, function(key) {
    ...
    escape: function (key) {
        ...
        return forEachItem(keysToEscape, function(key) {
            return escaper(self._attributes[key]);
        });
    },
    /**
    ...
    unset: function (key) {
        ...
        forEachItem(arguments, function(key) {
            delete self._attributes[key];
        });
    ...
    toObject : function (options) {
        ...
        for (key in obj) {
            if (obj.hasOwnProperty(key)) {
                ...
                //don't remove ID, even if it's null
                if (obj[key] === null && key !== idAttribute) {
                    delete obj[key];
                }

                //remove excluded fields
                //not in one loop because of idAttribute
