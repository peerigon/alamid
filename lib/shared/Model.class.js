...
var Model = new Class("Model", {
    ...
    init: function init(id) {
        ...
        this.__parentIds = {};
        this.__url = this.Instance.Class.url || null;
    ...
    getParentIds : function() {
        ...
        //always append own ID
        if(this._id !== null) {
            this.__parentIds[this.__url] = this._id;
        }
    ...
    set: function set(key, value) {
        ...
        function doSet(key, newValue) {
            ...
            if (key === "id") {
                throw new Error("(alamid) Setting ids via 'set' is not allowed. Use the constructor instead.");
            }
    ...
    save: function save(remote, callback) {
        ...
        function onServiceResponse(response) {
            ...
            if (!err) {
                ...
                self.Instance.Class.emit(method, event);
            }
    ...
    destroy: function (remote, callback) {
        ...
        function onServiceResponse(response) {
            ...
            if (!err) {
                ...
                self.Instance.Class.emit("destroy", event);
            }
            callback(err);
        }
        ...
        this.__callService(service.destroy, "destroy", remote, ids, onServiceResponse);
    },
    /**
