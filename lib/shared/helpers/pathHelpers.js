...
patterns = {    // functions are used to ensure that the regular expression object is always new
     ...
     * @return {RegExp}
     */
    schemaFile: function serviceFiles() { return /Schema(\.class)?\.js$/gi; },
...
modifiers = {
    ...
    /**
     * Export of node's internal path.normalize
     *
     * @param {!String} path
     * @return {String}
     */
...
function getFilterModifierChain() {
     ...
     *
     * @param {!String} path
     * @throws {TypeError} when a filter didn't returned true or false
     * @return {*}
     * @constructor
     */
...
exports.chain = exports.apply = {
     ...
     * @throws {TypeError}
     * @throws {Error} when the filter name is unknown
     * @return {FilterModifierChain}
     */
     ...
     * @param {String|Function} etc
     * @throws {TypeError}
     * @throws {Error} when the modifier name is unknown
     * @return {FilterModifierChain}
     */
