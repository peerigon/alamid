...
var ModelCollection = new Class({
    ...
    set: function (index, model) {
        ...
        if (elements[index] !== undefined) {
            changeListener =  this.__findChangeListener(elements[index]);
            elements[index].removeListener("change", changeListener);
        }
    ...
    sortBy: function (modelAttribute, descending) {
        ...
        this.Super.emit("change", 0, elements, elementsLength);
