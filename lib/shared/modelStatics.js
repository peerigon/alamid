...
var ModelCollection = require("./ModelCollection.class.js"),
    ...
    env = require("./env.js"),
    RemoteService; //will only be filled on client
...
function find (remote, ids, params, callback) {
    ...
    console.log(remote, ids, params, callback);
    ...
    if (env.isClient() && remote === true) {
        ...
        remote = (remoteService.readCollection).bind(remoteService);
    }
    ...
    //var serviceFunction = (service.readCollection).bind(service),
