...
var Collection = new Class({
    ...
    set: function (index, element) {
        ...
        this._emitEvent("add", index, [element], isMutated);
    ...
    pop: function () {
        ...
        this._emitEvent("remove", popIndex, [element], true);
    ...
    shift: function () {
        ...
        this._emitEvent("remove", 0, [element], true);
    ...
    push: function (models) {
        ...
        this._emitEvent("add", pushIndex, models, true);
    ...
    unshift: function (models) {
        ...
        this._emitEvent("add", 0, models, true);
