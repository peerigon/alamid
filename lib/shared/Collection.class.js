...
var Collection = new Class("Collection", {
    ...
    set: function (index, element) {
        ...
        if (value(element).notInstanceOf(this._Class)) {
            throw new TypeError(
    ...
    remove: function(index) {
        ...
        if (removedElement) {
            ...
            this._emitEvent("remove", [removedElement], index, true);
        }
    ...
    push: function (elements) {
        ...
        if (value(elements).instanceOf(Collection)) {
            ...
            _(elements).each(function pushModel(element, index) {
                if (value(element).notInstanceOf(self._Class)) {
                    throw new TypeError(
